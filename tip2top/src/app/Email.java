...
public class Email extends AmigoBuilder implements Serializable{
	...
	public void saveEmails (String savename) {
		...
		try { 
			FileOutputStream f = new FileOutputStream(new File("resources/emails/" + savename + ".email"));
	...
	public void loadEmails (String savename) {
		...
		try {
			FileInputStream fi = new FileInputStream(new File("resources/emails/" + savename + ".email"));
			ObjectInputStream oi = new ObjectInputStream(fi);

			// Read objects
			ArrayList<Email> emailList = (ArrayList<Email>) oi.readObject();
	...
	public void initializeEmails (String savename) {
		...
		emails.add(new Email("Dr. Bakare Tunde", "We need your space expertise.", "I am Dr. Bakare Tunde, the cousin of a Nigerian Astronaut, Air Force Major Abacha Tunde. He was the first African in space when he made a secret flight to the Salyut 6 space station in 1979. He was on a later Soviet spaceflight, Soyuz T-16Z, to the secret Soviet military space station Salyut 8T in 1989. He was stranded there in 1990 when the Soviet Union was dissolved. His other Soviet crew members returned to Earth on the Soyuz T-16Z, but his place was taken up by return cargo. There have been occasional supply flights to keep him going since that time. He is in good humor but wants to come home.\n" + 
				"\n" + 
		...
		emails.add(new Email("Hello", "It's me", "I've been wondering if after all these years you'd like to meet"));
